...
import service.user.{DefaultEnv, UserService, UserServiceImpl}
...
class SilhouetteModule extends AbstractModule with ScalaModule with AkkaGuiceSupport {
    ...
    /**
      ...
      */
    @Provides
    def provideOAuth1TokenSecretProvider(@Named("authenticator-cookie-signer") cookieSigner: CookieSigner,
                                         @Named("authenticator-crypter") crypter: Crypter,
                                         configuration: Configuration,
    ...
    /**
      ...
      */
    @Provides
    def provideOAuth2StateProvider(   @Named("authenticator-cookie-signer") cookieSigner: CookieSigner,
                                      idGenerator: IDGenerator,
                                   configuration: Configuration,
